...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['action']) && $_POST['action'] == 'edit') {
    ...
    // Update siswa table
    $update_siswa_query = "UPDATE siswa SET nm_siswa = '$nama_siswa' WHERE kd_siswa = '$kd_siswa'";
    if ($conn->query($update_siswa_query) !== TRUE) {
        echo "Error: " . $update_siswa_query . "<br>" . $conn->error;
    }
...
<head>
    ...
    <title>Tambah Data Siswa dan Ekstrakurikuler</title>
    <!-- Bootstrap CSS -->
                            ...
                            <tbody>
                                ...
                                while ($row_siswa = $result_siswa->fetch_assoc()) {
                                    ...
                                    if ($nama_kriteria == end($criteria_names)) {
                                        echo "<td>
                                                <button type='button' class='btn btn-warning btn-sm edit-btn' data-toggle='modal' data-target='#editDataModal' data-kd-siswa='{$kd_siswa}'>Edit</button>
                                              </td>";
                                        echo "</tr>";
                                    }
                                }
                                        ...
                                        <form method="POST" action="">
                                            ...
                                            while ($row_ekskul = $result_ekskul->fetch_assoc()) {
                                                ...
                                                foreach ($criteria_names as $criteria_name) {
                                                    ...
                                                    echo "<input type='number' class='form-control' id='edit_nilai_{$kd_ekskul}_{$criteria_name}' name='edit_nilai_{$kd_ekskul}_{$criteria_name}' required>";
                                                    echo "</div>";
                                                }
                                            }
                                            ?>
